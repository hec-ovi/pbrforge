...
Version: 0.18.0, matching `urbe-materials`. Package exports, schemas, catalog keys and consumer bindings are public boundaries. Breaking changes require orchestrator coordination.
...
District street recipes publish fine dark hexagonal road/parking joints, glossy blue/red panels, coordinated curb/gutter colors and blue/yellow junction finishes. Blue and dark panels and blue curbs carry restrained tonal and gloss variation. Native street bindings include their authored manifest, emissive parking edges and letter-atlas marquee faces. Capped marquee runs bind `marquee-channel` (grimy dark painted steel), `marquee-frame` (amber enamel), `marquee-lip` (pale concrete), `marquee-cap` (dark slate cast finish) at metre UVs and `marquee-led`, a `led-matrix` dot face whose dots light the placement text in warm white. Hexagons use a 0.15 m lattice; geometry owns full-size panel boundaries.
