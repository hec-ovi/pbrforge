# Street prop surfaces

The built-in image tool supplies physical-scale albedo fields and fitted wear panels. PBRForge from-image derives dry nonmetallic maps. Engine geometry supplies folds, dents, joints and hardware.

| Cyberpunk key | Variant | Source | Prompt | Maps |
| --- | --- | --- | --- | --- |
| prop-cardboard/poor | kraft | [PNG](cardboard.png) | [Prompt](cardboard.md) | [Set](../../themes/cyberpunk/assets/prop-cardboard/poor/kraft/) |
| prop-wood/poor | sawn | [PNG](wood.png) | [Prompt](wood.md) | [Set](../../themes/cyberpunk/assets/prop-wood/poor/sawn/) |
