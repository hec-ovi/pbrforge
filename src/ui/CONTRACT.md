...
- Search text filters the visible material rows. The list is a theme/kind/tier tree; headers collapse and expand. Each leaf shows 32px thumbs of that material's maps. Toolbar inputs select variant, repeat, lighting, background, spin and wireframe.
