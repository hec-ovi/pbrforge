...
- Approved city-screen direction: monumental adult portraits, near-black composition, and restricted cyan, teal, muted red, cobalt, or amber light. Keep the subject severe and distant, with large dark regions that survive fog and long viewing distance. Reject cheerful product shots, modern influencer lighting, readable copy, logos, and generic saturated studio backdrops. A useful short brief is "adult East Asian woman, retro vintage future-noir portrait" followed by the palette and aspect ratio.
- Generate separate 16:9 and 9:16 artwork. Do not crop one into the other. The source remains flat and brandless; LED cells, scan bands, display bloom, and wordmarks are composed by the screen lane at the target resolution.
