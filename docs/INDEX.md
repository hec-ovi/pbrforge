...
- from-image box: [src/from-image/CONTRACT.md](../src/from-image/CONTRACT.md). One opaque JPEG or PNG to a dry PBR set. No seam gate. No emission. Agent usage: [skills/pbrforge/references/from-image.md](../skills/pbrforge/references/from-image.md). Depends on Database write and the shared map derive writer.
