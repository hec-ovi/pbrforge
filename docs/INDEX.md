...
- CLI box: [src/cli/CONTRACT.md](../src/cli/CONTRACT.md). `pbrforge` verbs print one JSON envelope and exit. Skill pack: [skills/pbrforge/SKILL.md](../skills/pbrforge/SKILL.md). Depends on the root package operations.
