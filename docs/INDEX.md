...
- from-image box: [src/from-image/CONTRACT.md](../src/from-image/CONTRACT.md). One opaque PNG to a dry PBR set. No seam gate. No emission. Depends on Database write and the shared map derive writer.
